...
import (
	...
	"github.com/hxlb/user/repository"
...
func (e *User) Register(ctx context.Context, req *com_hxlb_srv_user.RegisterRequest, rsp *com_hxlb_srv_user.Response) error {
...
func (e *User) Login(ctx context.Context, req *com_hxlb_srv_user.LoginRequest, rsp *com_hxlb_srv_user.Response) error {
...
func (e *User) UpdatePassword(ctx context.Context, req *com_hxlb_srv_user.UpdatePasswordRequest, rsp *com_hxlb_srv_user.Response) error {
